...
class PostTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let selectedItem = selectedItem{
            if let image = UIImage(named: selectedItem.imageName){
    ...
    @IBAction func submitButton(_ sender: Any) {
        ...
        let alertController = UIAlertController(title: "Posted Successfully", message: "Your Post has been posted successfully.", preferredStyle: .alert)
...
//                        if let base64Image = self.selectedImage?.toBase64() {
//                                    eventsThisWeek.addfeeds(feed: FeedList(description: "Description 1", imageName: "post_3"))
//                                } else {
//                                    print("Failed to convert image to base64 string")
//                                }
                        DispatchQueue.main.async {
                                    feedVC.selectedImage = self.selectedImage
                                }
